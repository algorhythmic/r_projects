---
title: "A Naive Bayes Classification Model"
...
This analysis is an application of the Conditional Probability course. Using a dataset of pre-labeled SMS messages, we'll create a spam filter using the Naive Bayes algorithm.
